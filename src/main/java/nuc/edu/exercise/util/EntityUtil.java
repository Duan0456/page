...
public class EntityUtil {
    ...
    private final String moduleName = "exercise"; // 数据库名称

    private final String bean_path = "D:\\桌面\\实训\\exercise\\src\\main\\java";

    private final String mapper_path = "D:\\桌面\\实训\\exercise\\src\\main\\java\\nuc\\edu\\exercise\\dao";

    private final String xml_path = "D:\\桌面\\实训\\exercise\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "nuc.edu.exercise.model";// model的包所在

    private final String dao_package = "nuc.edu.exercise.dao";// dao的包所在
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import nuc.edu.search.util.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
